(function (definition) {
	...
	*/
	...
	CIQ.TFC.prototype.refreshScrollWindows=function(openOrderTop){
		var positionWrapper=$$$(".stx-section",$$$(".stx-panel-module.stx-trade-positions"));
		var openOrderWrapper=$$$(".stx-section",$$$(".stx-panel-module.stx-trade-current"));
	...
	CIQ.TFC.prototype.cancelOpenOrder=function(){
		...
		this.account.confirmOrder(this, order, function(confirmation){
			CIQ.TFC.displayDialog('#tfcConfirmOrder');
			...
			CIQ.safeClickTouch($$$("#tfcConfirmOrder .stx-ico-close"), CIQ.TFC.dismissDialog);
			var i, div;
	...
	CIQ.TFC.prototype.confirmReplace=function(order){
		...
		CIQ.safeClickTouch(abandonButton, CIQ.TFC.dismissDialog);
		CIQ.safeClickTouch($$$("#tfcConfirmReplace .stx-ico-close"), CIQ.TFC.dismissDialog);

		this.modalEnd();
		CIQ.TFC.displayDialog('#tfcConfirmReplace');
	...
	CIQ.TFC.prototype.confirmCloseAllPositions=function(){
		...
		CIQ.TFC.displayDialog('#tfcConfirmCloseAll');
		...
		CIQ.safeClickTouch(abandonButton, CIQ.TFC.dismissDialog);
		CIQ.safeClickTouch($$$("#tfcConfirmCloseAll .stx-ico-close"), CIQ.TFC.dismissDialog);
	...
	CIQ.TFC.prototype.confirmOCO=function(order, type){
		...
		CIQ.safeClickTouch(submitButton, closure(this, order, submitButton));
		CIQ.safeClickTouch(abandonButton, CIQ.TFC.dismissDialog);
		CIQ.safeClickTouch($$$("#tfcConfirmOCO .stx-ico-close"), CIQ.TFC.dismissDialog);

		this.modalEnd();
		CIQ.TFC.displayDialog('#tfcConfirmOCO');
