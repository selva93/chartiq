...
module.exports = {
	...
	module: {
		...
		rules: [
			 ...
			 * It is used for packaging imported images and images in styesheets when referenced with url() in setting a CSS property value (both CSS and SCSS).
			 * The options object sets a public path where you can find the output.
	...
	plugins: [
		 ...
		 */
		new CopyPlugin([
			{ from: 'js/thirdparty/html2canvas.js', to: 'js/thirdparty/html2canvas.js'}
		])
