...
(function (root, factory) {
  ...
  function (_CIQ$UI$ContextTag) {
    _inherits(ShareButton, _CIQ$UI$ContextTag);
  ...
  */
    ...
    _createClass(ChartTitle, [{
      ...
      value: function update() {
        ...
        if ((doUpdatePrice || doUpdateBrowserTab) && symbol && (symbolChanged || priceChanged)) {
          ...
          todaysChange = todaysChange !== undefined ? todaysChange : ""; // These strange characters create some spacing so that the title appears
  ...
  var ChartcontrolGroup =
  /*#__PURE__*/
  function (_CIQ$UI$ModalTag4) {
    _inherits(ChartcontrolGroup, _CIQ$UI$ModalTag4);

    function ChartcontrolGroup() {
      _classCallCheck(this, ChartcontrolGroup);

      return _possibleConstructorReturn(this, _getPrototypeOf(ChartcontrolGroup).call(this));
    }

    _createClass(ChartcontrolGroup, [{
      key: "connectedCallback",
      value: function connectedCallback() {
        if (this.attached) return;

        _get(_getPrototypeOf(ChartcontrolGroup.prototype), "connectedCallback", this).call(this);
      }
    }, {
      key: "setContext",
      value: function setContext(context) {
        var node = this.node; // Prevent interaction events from propagating through the panel to the chart
  ...
  function (_CIQ$UI$ContextTag2) {
    _inherits(Clickable, _CIQ$UI$ContextTag2);
  ...
  function (_CIQ$UI$ModalTag5) {
    _inherits(Comparison, _CIQ$UI$ModalTag5);
    ...
    _createClass(Comparison, [{
        ...
        for (var r in stx.chart.seriesRenderers) {
          ...
          for (var s = 0; s < renderer.seriesParams.length; s++) {
            ...
            if (seriesParameters.opacity) {
              comparisonSwatch.css({
                "opacity": seriesParameters.opacity
              });
              swatch.css({
                "opacity": seriesParameters.opacity
              });
      ...
      key: "setColor",
      value: function setColor(color, swatch) {
        if (swatch.seriesId) this.context.stx.modifySeries(swatch.seriesId, {
          color: color
        });
      }
      /**
  ...
  function (_CIQ$UI$ContextTag3) {
    _inherits(CVPController, _CIQ$UI$ContextTag3);
  ...
  function (_CIQ$UI$DialogContent) {
    _inherits(DrawingContext, _CIQ$UI$DialogContent);
  ...
  function (_CIQ$UI$DialogContent2) {
    _inherits(FibSettingsDialog, _CIQ$UI$DialogContent2);
  ...
  */
  ...
  function (_HTMLElement2) {
    _inherits(Heading, _HTMLElement2);
    ...
    _createClass(Heading, [{
      ...
      key: "createFilter",
      value: function createFilter(placeholder) {
        ...
        var itemContainer = this.nextElementSibling;
        $(input, this).on('keyup input', function (e) {
          var value = e.target.value;
          var re = new RegExp(value, 'i');
          $('cq-item', itemContainer).each(function () {
            var visibilityAction = value && !re.test(this.textContent) ? 'add' : 'remove';
      ...
      key: "showFilterIfNecessary",
      value: function showFilterIfNecessary() {
  ...
  function (_HTMLElement3) {
    _inherits(InstantChart, _HTMLElement3);
  ...
  function (_CIQ$UI$DialogContent3) {
    _inherits(LanguageDialog, _CIQ$UI$DialogContent3);
  ...
  function (_CIQ$UI$ContextTag4) {
    _inherits(Loader, _CIQ$UI$ContextTag4);
  ...
  function (_CIQ$UI$ContextTag5) {
    _inherits(Lookup, _CIQ$UI$ContextTag5);
  ...
  function (_CIQ$UI$ContextTag6) {
    _inherits(PaletteDock, _CIQ$UI$ContextTag6);
  ...
  function (_CIQ$UI$ContextTag7) {
    _inherits(Palette, _CIQ$UI$ContextTag7);
  ...
  function (_CIQ$UI$ContextTag8) {
    _inherits(Redo, _CIQ$UI$ContextTag8);
  ...
  function (_CIQ$UI$DialogContent4) {
    _inherits(AggregationDialog, _CIQ$UI$DialogContent4);
  ...
  function (_CIQ$UI$DialogContent5) {
    _inherits(ShareDialog, _CIQ$UI$DialogContent5);
  ...
  var StudyLegend =
  /*#__PURE__*/
  function (_CIQ$UI$ModalTag6) {
    _inherits(StudyLegend, _CIQ$UI$ModalTag6);
  ...
  function (_HTMLElement5) {
    _inherits(Swatch, _HTMLElement5);
    ...
    _createClass(Swatch, [{
      ...
      key: "setColor",
      value: function setColor(color, percolate, isAuto) {
        var node = $(this);
        var bgColor = CIQ.getBackgroundColor(this.parentNode);
        var border = CIQ.chooseForegroundColor(bgColor);
    ...
    _createClass(DrawingPalette, [{
      ...
      value: function setEvenOdd(groupName) {
        ...
        nodes.filter(':visible').each(function (n) {
          if (n % 2) this.classList.add('odd');else this.classList.remove('odd');
        });
      ...
      */
      ...
      key: "noTool",
      value: function noTool(activator, toolName) {
